...
require([
    ...
    setContent('contigsetbrowser', 'status', loading());

    setContent('assemblybrowser', 'status', loading());
            ...
            .then(function (objects) {
                ...
                var table = html.tag('table'), tr = html.tag('tr'),
                    ...
                    listing = table({class: 'table'}, [
                        ...
                        return tr([
                            td(a({href: 'assemblyAllMethods.html?objectRef=' + objectInfo.ref, target: '_blank'}, objectInfo.name)),
    ...
    session.login({
        ...
        .then(function () {
            return loadType('contigsetbrowser', 'KBaseGenomes.ContigSet');
        })
        .then(function () {
            return loadType('assemblybrowser', 'KBaseGenomeAnnotations.Assembly');
        })
        .catch(function (err) {
            console.error('ERROR');
            console.error(err);
